    ...
    rules: [
      ...
      // in development "style" loader enables hot editing of CSS.
      {
        ...
        use: [
          ...
          {
            loader: 'css-loader?importLoaders=1' // creates style nodes from JS strings
          },
          {
      ...
      },
      {
        ...
        use: [
          ...
          {
            loader: 'css-loader?modules=true&localIdentName=[name]_[local]_[hash:base64:7]&importLoaders=2' // translates CSS into CommonJS
          },
          {
